...
export const checkPermission = (
    permission: bigint,
    channel: Channel | undefined = getCurrentChannel(),
    user?: User
): boolean => {
    return channel && PermissionStore.can(permission, channel, user);
};
 ...
 */
export const hasEmbedPermission = (channelId: string | undefined = getCurrentChannel()?.id): boolean => {
